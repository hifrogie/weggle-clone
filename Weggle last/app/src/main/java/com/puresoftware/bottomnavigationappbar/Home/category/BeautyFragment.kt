...
import com.puresoftware.bottomnavigationappbar.databinding.FragmentBeautyBinding
...
class BeautyFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        groupManager.getCategoryProduct("beauty"){
            ...
            binding.beautyRecycler.layoutManager = GridLayoutManager(context,2)
        }
    }
}