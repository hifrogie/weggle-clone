...
import com.puresoftware.bottomnavigationappbar.databinding.FragmentInteriorBinding
...
class InteriorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        groupManager.getCategoryProduct("interior"){
            ...
            binding.interiorRecycler.layoutManager = GridLayoutManager(context,2)
        }
    }
}