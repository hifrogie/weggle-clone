...
import com.puresoftware.bottomnavigationappbar.databinding.FragmentLivingBinding
...
class LivingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentLivingBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        groupManager.getCategoryProduct("houseHold"){
            ...
            binding.livingRecycler.layoutManager = GridLayoutManager(context,2)
        }
    }
}